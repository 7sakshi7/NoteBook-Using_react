...
const ShortestPathTemplate = (props) => {
  React.useEffect(() => {
    ...
    function color(e) {
      if (!e.target.classList.contains("blocks")) return;
    ...
    function findCoords() {
      const cells = document.querySelectorAll(".blocks");
      let c = 0;
      let sx = -1,
        sy = -1,
        dx = -1,
  ...
  return (
    <div className="top-container" style={{background: "#deeef5"}}>
