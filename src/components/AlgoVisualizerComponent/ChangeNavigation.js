...
const ChangeNavigation = (tab) => {
  if (tab === 0) {
    return searching.map((element, index) => {
      return (
        <Link to={searching[index].path} className="navigation_cell" key={index}>
          <li className="cell ">
    ...
    return sorting.map((element, index) => {
      return (
        <Link to={sorting[index].path} className="navigation_cell" key={index}>
          <li className="cell ">
            <div className="cell-child">
              <div className="cell_box">
    ...
    return automata.map((element, index) => {
      return (
        <Link to={automata[index].path} className="navigation_cell" key={index}>
          <li className="cell ">
            <div className="cell-child">
              <div className="cell_box">
